  ...
  const agencyServices = [
    {
      ...
      description:
        "আপনার পছন্দ ও যোগ্যতা অনুযায়ী সঠিক বিশ্ববিদ্যালয় ও কোর্স নির্বাচন",
    },
    {
    ...
    },
    {
      ...
      description:
        "আপনার প্রদানকৃত তথ্যের ভিত্তিতে GTE স্টেটমেন্ট প্রস্তুত করা",
    },
    {
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90">
              এজেন্সি সাধারণত আপনার জন্য যা করে থাকে
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {agencyServices.map((service, index) => (
              <Card
                key={index}
                className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 transition-all duration-300 hover:-translate-y-2 group"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {studentSteps.map((step, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-lg p-6 border-l-4 border-gray-400 hover:border-gray-600 hover:bg-gray-100 transition-all duration-300 group"
              >
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/about">
              <Button
                variant="outline"
                className="border-2 border-white hover:bg-white text-lg px-8 py-4 rounded-full font-medium transition-all duration-300 transform hover:scale-105 text-purple-600"
              >
                আরও জানুন
              </Button>
            </Link>
