        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              ১০ বছরের অভিজ্ঞতা নিয়ে আমরা হাজারো শিক্ষার্থীর স্বপ্ন পূরণে
              সাহায্য করেছি। আপনার বিদেশে উচ্চশিক্ষার স্বপ্নও আমরা বাস্তবায়ন
              করব।
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                BEGL BD এর মূল লক্ষ্য হলো বাংলাদেশী শিক্ষার্থীদের বিদেশে
                উচ্চশিক্ষার সুযোগ সৃষ্টি করা। আমরা বিশ্বাস করি প্রতিটি মেধাবী
                শিক্ষার্থীর বিশ্বমানের শিক্ষা গ্রহণের অধিকার রয়েছে।
              </p>
